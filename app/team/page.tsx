...
import { ArrowLeft, Github, Linkedin, Mail, Music } from "lucide-react"
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="group relative overflow-hidden rounded-lg border bg-background p-6 shadow-md transition-shadow hover:shadow-lg">
                ...
                <div className="mb-4 flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold">Oğuzhan Aybar</h3>
                    <p className="text-sm text-gray-500">CEO & AI Specialist</p>
                  </div>
                </div>
                <p className="mb-4 text-gray-600">
                  AI specialist with a background in audio processing. Oğuzhan leads our engineering team and oversees the
              ...
              <div className="group relative overflow-hidden rounded-lg border bg-background p-6 shadow-md transition-shadow hover:shadow-lg">
                ...
                <div className="mb-4 flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold">Zeynep Kara</h3>
                    <p className="text-sm text-gray-500">CTO & Application Developer</p>
                  </div>
                </div>
                <p className="mb-4 text-gray-600">
                    Full-stack developer with years of experience. Zeynep is responsible for the development of our application and
                  providing users an easy-to-use interface.
                </p>
                <div className="flex gap-2">
                  <Button variant="ghost" size="icon" className="h-8 w-8 rounded-full">
                    <Github className="h-4 w-4" />
              ...
              <div className="group relative overflow-hidden rounded-lg border bg-background p-6 shadow-md transition-shadow hover:shadow-lg">
                ...
                <div className="mb-4 flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold">Kaan Karataş</h3>
                    <p className="text-sm text-gray-500">CIO & Musical Specialist</p>
                  </div>
                </div>
                <p className="mb-4 text-gray-600">
                  Full-stack developer and part-time bassist. Kaan is responsible for supervising the musical aspects of the
                  project and ensuring a seamless experience combining both industries.
                </p>
                <div className="flex gap-2">
                  <Button variant="ghost" size="icon" className="h-8 w-8 rounded-full">
                    <Github className="h-4 w-4" />
